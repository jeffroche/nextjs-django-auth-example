...
class Review(AuditHistory):
    ...
    coffee = models.ForeignKey("Coffee", related_name="reviews", on_delete=models.CASCADE)
    preparation = models.ForeignKey("Preparation", related_name="review_preps", on_delete=models.CASCADE)